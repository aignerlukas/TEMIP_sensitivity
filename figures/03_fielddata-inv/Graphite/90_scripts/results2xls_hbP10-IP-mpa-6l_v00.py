...
filename = 'hb-p10_6lay-mpa'
version = 'v00_tr5-400us'                      # v02_tr5-400us, v02_tr5-500us, v03_tr6-400us
...
path_main = '../../../'
path_results = path_main + f'03-inv_results/pyGIMLi/{filename}/{version}/'
...
if use_only_xz:
    ...
    # ids_coord = [f'{id:06d}' for id in df_coord.name]
    ids_coord = list(df_coord.name)
