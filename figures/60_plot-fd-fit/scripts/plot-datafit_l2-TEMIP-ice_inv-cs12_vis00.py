...
invrun = '000'
time_range = 'tr12-100us'
fname_result = f'20210716-sb_Line2-xz_{invrun}_{inv_version}'
lid = 'sb-l2_blk-6lay-mpa'
profile = 'sb-line-02'

path_main = '../../03_fielddata-inv/Ice/'
path = path_main + f'30_TEM-results/{lid}/{profile}/{inv_version}_{time_range}/'
fids = glob(path + fname_result + '.xls')

path_raw = path_main + "00_data/selected/"
fname_raw = 'sb-line-02.tem'
...
srvy.plot_datafit_multi_fig(ax=None, savefid=savefid, dpi=200,
                            nrows_to_plot=1, width_factor=2.5,
                            xlimits=(3e-6, 3e-4), ylimits=(1e-8, 1e-3))